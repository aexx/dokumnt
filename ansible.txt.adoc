...
- hosts: aspix3950
  ...
  - name : Install multiple packages
    ...
    loop: [git, krusader, meld, btop, asciidoc, nmap, screen, krename, wakeonlan, x2goclient, pdftk-java, remmina-plugin-x2go, remmina-plugin-x2go, autokey-qt, autokey-gtk, nala]
----
